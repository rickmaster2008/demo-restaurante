...
let components = {
	nprogress: {
		selector: 'html',
		styles: '/static/www/components/nprogress/nprogress.css',
		script: '/static/www/components/nprogress/nprogress.js',
		init: function () {
			NProgress.configure({
	...
	sessionTimeout: {
		...
		styles: [
			'/static/www/components/modal/modal.css',
			'/static/www/components/animate/animate.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js',
			'/static/www/components/session-timeout/session-timeout.js'
		],
		init: function () {
			let
	...
	highlight: {
		selector: '.highlight',
		styles: '/static/www/components/highlight/highlight.css',
		script: '/static/www/components/highlight/highlight.pack.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	dualListBox: {
		...
		styles: [
			'/static/www/components/button/button.css',
			'/static/www/components/input/input.css',
			'/static/www/components/mdi/mdi.css',
			'/static/www/components/dual-listbox/dual-listbox.css'
		],
		script: '/static/www/components/dual-listbox/dual-listbox.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	breadcrumbs: {
		...
		styles: '/static/www/components/breadcrumbs/breadcrumbs.css'
	},
	badge: {
		selector: '.badge',
		styles: '/static/www/components/badge/badge.css'
	},
	code: {
		selector: 'code',
		styles: '/static/www/components/code/code.css'
	},
	dropCap: {
		selector: '.drop-cap',
		styles: '/static/www/components/drop-cap/drop-cap.css'
	},
	media: {
		selector: '.media',
		styles: '/static/www/components/media/media.css'
	},
	card: {
		selector: '.card',
		styles: '/static/www/components/card/card.css'
	},
	panel: {
		selector: '.panel',
		styles: '/static/www/components/panel/panel.css'
	},
	adminPanel: {
		selector: '.panel.admin-panel',
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/admin-panel/admin-panel.css'
		],
		script: [
			'/static/www/components/admin-panel/class-switch.js',
			'/static/www/components/admin-panel/admin-panel.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	divider: {
		selector: '.divider',
		styles: '/static/www/components/divider/divider.css'
	},
	blockquote: {
		selector: '.blockquote',
		styles: '/static/www/components/blockquote/blockquote.css'
	},
	section: {
		selector: 'section',
		styles: '/static/www/components/section/section.css'
	},
	alert: {
		selector: '.alert',
		styles: '/static/www/components/alert/alert.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js'
	...
	alertToggle: {
		...
		script: '/static/www/components/base/jquery-3.4.1.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	dropdown: {
		...
		styles: '/static/www/components/dropdown/dropdown.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js'
	...
	invoice: {
		...
		styles: '/static/www/components/invoice/invoice.css'
	},
	button: {
		selector: '.btn',
		styles: '/static/www/components/button/button.css'
	},
	table: {
		selector: '.table',
		styles: '/static/www/components/table/table.css'
	},
	list: {
		selector: '[class*="list"]',
		styles: '/static/www/components/list/list.css'
	},
	progress: {
		selector: '.progress',
		styles: '/static/www/components/progress/progress.css'
	},
	nav: {
		selector: '.nav',
		styles: '/static/www/components/nav/nav.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js'
	...
	input: {
		...
		styles: '/static/www/components/input/input.css'
	},
	maxlength: {
		selector: '[maxlength]',
		styles: [
			'/static/www/components/badge/badge.css',
			'/static/www/components/maxlength/maxlength.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/maxlength/bootstrap-maxlength.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).maxlength({
	...
	typeahead: {
		...
		styles: '/static/www/components/typeahead/typeahead.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/typeahead/typeahead.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	select2: {
		selector: '.select2',
		styles: '/static/www/components/select2/select2.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/select2/select2.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				node = $( node );
	...
	fontAwesome: {
		selector: '[class*="fa-"]',
		styles: '/static/www/components/font-awesome/font-awesome.css'
	},
	mdi: {
		selector: '[class*="mdi-"]',
		styles: '/static/www/components/mdi/mdi.css'
	},
	spinner: {
		selector: '[data-spinner]',
		styles: '/static/www/components/spinner/spinner.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/base/jquery-ui.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).spinner({
	...
	timeSpinner: {
		...
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/base/jquery-ui.min.js',
			'/static/www/components/base/globalize.min.js'
		],
		init: function ( nodes ) {
	...
	daterangepiker: {
		...
		styles: [
			'/static/www/components/button/button.css',
			'/static/www/components/daterangepicker/daterangepicker.css'
		],
		script: [
			'/static/www/components/base/moment.min.js',
			'/static/www/components/daterangepicker/daterangepicker.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				node = $( node );
	...
	datetimepicker: {
		...
		styles: [
			'/static/www/components/button/button.css',
			'/static/www/components/dropdown/dropdown.css',
			'/static/www/components/datetimepicker/bootstrap-datetimepicker.css'
		],
		script: [
			'/static/www/components/base/moment.min.js',
			'/static/www/components/datetimepicker/bootstrap-datetimepicker.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let $node = $( node );
	...
	tagManager: {
		...
		styles: [
			'/static/www/components/badge/badge.css',
			'/static/www/components/tag-manager/tag-manager.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/tag-manager/tag-manager.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	tooltip: {
		...
		styles: '/static/www/components/tooltip/tooltip.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js'
	...
	popover: {
		...
		styles: '/static/www/components/popover/popover.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js'
	...
	colorpicker: {
		...
		styles: [
			'/static/www/components/popover/popover.css',
			'/static/www/components/colorpicker/colorpicker.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js',
			'/static/www/components/colorpicker/colorpicker.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	maskedinput: {
		...
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/maskedinput/jquery.maskedinput.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	ckeditor: {
		...
		styles: '/static/www/components/ckeditor/ckeditor.css',
		script: '/static/www/components/ckeditor/ckeditor.min.js',
		init: function ( nodes ) {
			let promises = [];
	...
	close: {
		selector: '.close',
		styles: '/static/www/components/close/close.css'
	},
	summernote: {
		selector: '.summernote',
		styles: [
			'/static/www/components/button/button.css',
			'/static/www/components/input/input.css',
			'/static/www/components/table/table.css',
			'/static/www/components/close/close.css',
			'/static/www/components/dropdown/dropdown.css',
			'/static/www/components/tooltip/tooltip.css',
			'/static/www/components/popover/popover.css',
			'/static/www/components/modal/modal.css',
			'/static/www/components/card/card.css',
			'/static/www/components/summernote/summernote.css',
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/bootstrap/js/popper.js',
			'/static/www/components/bootstrap/js/bootstrap.min.js',
			'/static/www/components/summernote/summernote.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).summernote({
	...
	markdown: {
		selector: '.markdown',
		styles: [
			'/static/www/components/markdown/markdown.css',
			'/static/www/components/button/button.css',
			'/static/www/components/blockquote/blockquote.css',
			'/static/www/components/font-awesome/font-awesome.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/markdown/markdown.js',
			'/static/www/components/markdown/to-markdown.js',
			'/static/www/components/markdown/bootstrap-markdown.js',
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).markdown({
	...
	nestable: {
		...
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/nestable/nestable.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/nestable/nestable.js'
		],
		init: function ( nodes ) {
			$( nodes ).nestable({
	...
	jstree: {
		...
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/jstree/jstree.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/jstree/jstree.min.js'
			],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				node = $( node );
	...
	cropper: {
		...
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/cropper/cropper.css'
		],
		script: '/static/www/components/cropper/cropper.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let
	...
	fileupload: {
		...
		styles: [
			'/static/www/components/mdi/mdi.css',
			'/static/www/components/tower-file-input/tower-file-input.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/tower-file-input/tower-file-input.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				$( node ).fileInput({
	...
	easyzoom: {
		selector: '.easyzoom',
		styles: '/static/www/components/easyzoom/easyzoom.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/easyzoom/easyzoom.min.js'
		],
		init: function ( nodes ) {
			$( nodes ).easyZoom();
		}
	...
	xzoom: {
		selector: '.xzoom',
		styles: '/static/www/components/xzoom/xzoom.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/xzoom/xzoom.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	slick: {
		...
		styles: '/static/www/components/slick/slick.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/slick/slick.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let
	...
	dropzone: {
		...
		styles: '/static/www/components/dropzone/dropzone.css',
		script: '/static/www/components/dropzone/dropzone.min.js',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				new Dropzone( node, {
					paramName: "file",
	...
	fullscreen: {
		...
		styles: '/static/www/components/fullscreen/fullscreen.css',
	...
	animationSample: {
		...
		styles: '/static/www/components/animate/animate.css',
		init: function ( nodes ) {
			let
				timeoutId = null,
				endCb = null,
	...
	pnotify: {
		...
		styles: [
			'/static/www/components/alert/alert.css',
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/pnotify/pnotify.css'
		],
		script: [
			'/static/www/components/pnotify/PNotify.min.js',
			'/static/www/components/pnotify/PNotifyButtons.min.js'
		],
		init: function ( nodes ) {
	...
	pagination: {
		selector: '.pagination',
		styles: '/static/www/components/pagination/pagination.css'
	},
	datatables: {
		selector: '.data-table',
		styles: [
			'/static/www/components/datatables/datatables.css',
			'/static/www/components/pagination/pagination.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/base/jquery-ui.min.js',
			'/static/www/components/datatables/datatables.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let opts = {
	...
	driver: {
		...
		styles: '/static/www/components/driver/driver.css',
		script: '/static/www/components/driver/driver.min.js',
		init: function ( nodes ) {
			let
				defaults = {
					animate: true,
	...
	countdown: {
		selector: '.countdown',
		styles: '/static/www/components/countdown/countdown.css',
		script: [
			'/static/www/components/base/util.min.js',
			'/static/www/components/progress-circle/progress-circle.js',
			'/static/www/components/countdown/countdown.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	progressCircle: {
		...
		styles: '/static/www/components/progress-circle/progress-circle.css',
		script: [
			'/static/www/components/base/util.min.js',
			'/static/www/components/progress-circle/counter.js',
			'/static/www/components/progress-circle/progress-circle.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	particles: {
		...
		styles: '/static/www/components/particles/particles.css',
		script: [
			'/static/www/components/base/util.min.js',
			'/static/www/components/particles/particles.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				let
	...
	searchResult: {
		...
		styles: '/static/www/components/search-result/search-result.css'
	},
	timeline: {
		selector: '.timeline',
		styles: '/static/www/components/timeline/timeline.css',
		init: function ( nodes ) {
	...
	lightgallery: {
		...
		styles: '/static/www/components/lightgallery/lightgallery.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/lightgallery/lightgallery.min.js',
			'/static/www/components/base/util.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	fullcalendar: {
		...
		styles: [
			'/static/www/components/fullcalendar/fullcalendar.css',
			'/static/www/components/button/button.css',
			'/static/www/components/table/table.css',
			'/static/www/components/alert/alert.css',
			'/static/www/components/card/card.css',
		...
		script: [
			...
			'/static/www/components/base/jquery-ui.min.js',
			'/static/www/components/base/moment.min.js',
			'/static/www/components/fullcalendar/fullcalendar.min.js',
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	jvectorMap: {
		...
		styles: '/static/www/components/jvector-map/jvector-map.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/jvector-map/jvector-map.js',
			'/static/www/components/jvector-map/assets/world-mill.js',
			'/static/www/components/jvector-map/assets/us-lcc-en.js'
		],
		init: function ( nodes ) {
	...
	flotchart: {
		...
		styles: '/static/www/components/flotchart/flotchart.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/flotchart/flotchart.js',
			'/static/www/components/flotchart/flotchart-resize.js',
			'/static/www/components/flotchart/flotchart-pie.js',
			'/static/www/components/flotchart/flotchart-tooltip.js'
		],
		init: function ( nodes ) {
			var options = {
	...
	currentDevice: {
		selector: 'html',
		script: [
			'/static/www/components/current-device/current-device.min.js',
		]
	},
	rdNavbar: {
		selector: '.rd-navbar',
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/rd-navbar/rd-navbar.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/rd-navbar/rd-navbar.min.js'
		],
		dependencies: 'currentDevice',
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	sidebar: {
		selector: '.sidebar',
		styles: '/static/www/components/sidebar/sidebar.css'
	},
	mobileSidebar: {
		selector: '.mobile-sidebar',
		styles: '/static/www/components/mobile-sidebar/mobile-sidebar.css'
	},
	highchartsDouble: {
		selector: '[data-highcharts-double="container"]',
		styles: '/static/www/components/highcharts/highcharts.css',
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/highcharts/highcharts.js',
			'/static/www/components/highcharts/highcharts-double.init.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
	...
	gmap: {
		selector: '.google-map',
		styles: '/static/www/components/google-map/google-map.css',
		script: [
			'//maps.google.com/maps/api/js?key=AIzaSyBHij4b1Vyck1QAuGQmmyryBYVutjcuoRA&libraries=geometry,places&v=quarterly',
			'/static/www/components/google-map/google-map.js'
		],
		init: function ( nodes ) {
			let promises = [];
	...
	topbar: {
		selector: '.topbar',
		styles: '/static/www/components/topbar/topbar.css'
	},
	multiswitch: {
		selector: '[data-multi-switch]',
		script: '/static/www/components/multiswitch/multiswitch.js',
		dependencies: [
			'currentDevice',
			'rdNavbar'
		],
	...
	jumbotron: {
		selector: '.jumbotron',
		styles: '/static/www/components/jumbotron/jumbotron.css'
	},
	iconBox: {
		selector: '.icon-box',
		styles: '/static/www/components/icon-box/icon-box.css'
	},
	dockModal: {
		selector: '[data-dockmodal-button]',
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/dockmodal/dockmodal.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/dockmodal/dockmodal.min.js'
		],
		init: function ( nodes ) {
			nodes.forEach( function ( node ) {
				node.addEventListener( 'click', function() {
	...
	widgetCounter: {
		...
		styles: '/static/www/components/widget-counter/widget-counter.css'
	},
	scroller: {
		selector: '.scroller',
		styles: '/static/www/components/scroller/scroller.css'
	},
	user: {
		selector: '.user',
		styles: '/static/www/components/user/user.css'
	},
	jquerySortable: {
		selector: '.sortable',
		styles: [
			'/static/www/components/font-awesome/font-awesome.css',
			'/static/www/components/jquery-sortable/jquery-sortable.css'
		],
		script: [
			'/static/www/components/base/jquery-3.4.1.min.js',
			'/static/www/components/base/jquery-ui.min.js'
	...
	stateface: {
		selector: '.stateface',
		styles: '/static/www/components/stateface/stateface.css'
	},
	footer: {
		selector: '.footer',
		styles: '/static/www/components/footer/footer.css'
	},
	toTop: {
		selector: '.to-top',
		script: '/static/www/components/base/jquery-3.4.1.min.js',
